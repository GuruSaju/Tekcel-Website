...
function ServiceCtrl(){
     ...
     this.content = [

      {
        ...
        "domainhead": "We understand that every industry will have its challenges. We offer services by ensuring the the right skill, knowledge and expertise is available to you. We flourish in the following domains:",
        "domain1": "Banking",
        "domain2": "Finance",
        "domain3": "Insurance",
        "domain4": "Government",
